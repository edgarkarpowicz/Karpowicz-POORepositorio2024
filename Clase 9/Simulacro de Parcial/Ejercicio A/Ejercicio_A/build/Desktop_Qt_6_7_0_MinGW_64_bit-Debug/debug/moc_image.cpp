...
struct qt_meta_stringdata_CLASSImageENDCLASS_t {};
...
Q_CONSTINIT static const uint qt_meta_data_CLASSImageENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Image::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CLASSImageENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSImageENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSImageENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Image::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSImageENDCLASS.stringdata0))
