...
public:
    ...
    void setupUi(QWidget *Registro)
    {
        ...
        pbRegistrase = new QPushButton(Registro);
        pbRegistrase->setObjectName("pbRegistrase");

        gridLayout->addWidget(pbRegistrase, 5, 1, 1, 1);
    ...
    void retranslateUi(QWidget *Registro)
    {
        ...
        pbRegistrase->setText(QCoreApplication::translate("Registro", "Registrarse", nullptr));
    } // retranslateUi
