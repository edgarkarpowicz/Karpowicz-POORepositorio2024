...
Q_CONSTINIT const QMetaObject Login::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSLoginENDCLASS_t,
        ...
        // method 'signal_logging_in'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'signal_go_to_registry'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'slot_verificar_usuario'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'slot_registrarse'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void Login::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->signal_logging_in(); break;
        case 1: _t->signal_go_to_registry(); break;
        case 2: _t->slot_verificar_usuario(); break;
        case 3: _t->slot_registrarse(); break;
        default: ;
        }
        ...
        {
            using _t = void (Login::*)();
            if (_t _q_method = &Login::signal_logging_in; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Login::*)();
            if (_t _q_method = &Login::signal_go_to_registry; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Login::signal_logging_in()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Login::signal_go_to_registry()
{
